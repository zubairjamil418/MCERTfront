...
export const getDefaultFormData = () => ({
  ...
  // Type of Flowmeter(s): From Excel — H5 & H6 (combined)
  // Example: "Pulsar Ultra 5"
  secondaryDeviceType: "",
  ...
  // Flow Meter Verification (Section 3.3) — fixed paragraphs with 4 Excel variables (I26, I27, D23, D24)
  verificationDescription: "",
  verificationCalibrationReference: "Calibration Reference: Blue Collar 212mm (±1mm)",
...
export const mapFormDataFromAPI = (apiData) => {
  ...
  return {
    ...
    variableflow: formDataToMap.variableflow || "",
